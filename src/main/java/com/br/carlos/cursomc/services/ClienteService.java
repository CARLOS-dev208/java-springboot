...
import com.br.carlos.cursomc.dto.ClienteDTO;
...
import com.br.carlos.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DataIntegrityException("Não é possivel excluir usuario,pois possui entidades relacionada");
		}
