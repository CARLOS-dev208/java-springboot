...
import com.br.carlos.cursomc.domain.ItemPedido;
...
import com.br.carlos.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 =new Categoria(null,"Caderno");
		Categoria cat5 =new Categoria(null,"Mesa");
		Categoria cat6 =new Categoria(null,"Curtina");
		Categoria cat7 =new Categoria(null,"Cadeira");
		Categoria cat8 =new Categoria(null,"Escova");
		Categoria cat9 =new Categoria(null,"Garafa");
		Categoria cat10 =new Categoria(null,"Ventilado");
